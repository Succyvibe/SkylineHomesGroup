<template>
  ...
  >
    ...
    >
      <!-- Language Toggle -->
      <div class="max-w-3xl mx-auto px-4 py-6 flex justify-end space-x-2">
        <span class="text-sm font-medium self-center">Choose Language:</span>
        <button
      ...
      <div v-if="lang === 'en'" class="text-lg">
        ...
        <p>
          ...
          fully refundable $300 fee. This helps us coordinate
          ...
          <br />
          <span class="font-semibold">
            Fully refundable, whether or not you secure any of our apartments.</span
          >
          ...
          <div class="border-b border-gray-900/10 pb-12">
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div class="sm:col-span-3">
                ...
                >
                  <span v-if="lang === 'en'">First name</span>
                  <span v-if="lang === 'es'">Nombre</span>
                </label>
                <div class="mt-2">
                  <input
                    type="text"
              ...
              <div class="sm:col-span-3">
                <label
                  ...
                  class="block text-sm/6 font-medium text-gray-900"
                >
                  <span v-if="lang === 'en'">Last name</span>
                  <span v-if="lang === 'es'">Apellido</span>
                </label>
                <div class="mt-2">
                  <input
                    type="text"
              ...
              <div class="sm:col-span-3">
                <label
                  ...
                  class="block text-sm/6 font-medium text-gray-900"
                >
                  <span v-if="lang === 'en'">Mobile Number:</span>
                  <span v-if="lang === 'es'">Número de móvil:</span>
                </label>
              ...
              <div class="sm:col-span-3">
                <label
                  ...
                  class="block text-sm/6 font-medium text-gray-900"
                >
                  <span v-if="lang === 'en'">Country</span>
                  <span v-if="lang === 'es'">País</span>
                </label>
                <div class="sm:col-span-3">
              ...
              <div class="sm:col-span-3">
                <label
                  ...
                  class="block text-sm/6 font-medium text-gray-900"
                >
                  {{ language === 'es' ? 'Nombre del agente' : "Agent's Name" }}
                </label>
                <div class="mt-2">
                  <input
                    type="text"
              ...
              <div class="sm:col-span-3">
                ...
                >
                  {{
                    language === 'es'
                      ? 'Nombre del propietario anterior (opcional)'
                      : "Former Landlord's Name (Optional)"
                  }}
                </label>
                <div class="mt-2">
                  <input
                    ...
                    :placeholder="
                      language === 'es'
                        ? 'Ingresa el nombre del propietario anterior'
                        : 'Enter former landlord\'s name'
                    "
                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                  />
                </div>
              ...
              <div class="sm:col-span-full">
                ...
                >
                  {{
                    language === 'es'
                      ? 'Nombres de otras personas que ocuparán el apartamento (indique su relación con ellas)'
                      : 'Names Of Other Persons To Occupy The Apartment (state relationship with the persons)'
                  }}
                </label>
                <div class="mt-2">
                  <textarea
                    ...
                    :placeholder="
                      language === 'es'
                        ? 'Ej: Juan Pérez (hermano)'
                        : 'e.g., John Doe (brother)'
                    "
                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                  ></textarea>
                </div>
              ...
              <div class="sm:col-span-full mt-4">
                ...
                >
                  ...
                  <!-- <option value="moneyorder">
                    {{ lang === 'es' ? 'Giro postal' : 'Money Order' }}
                  </option> -->
                  <!-- <option value="cash">
              ...
              <div class="sm:col-span-full">
                ...
                >
                  <span v-if="lang === 'en'">Submit Application</span>
                  <span v-if="lang === 'es'">Enviar Solicitud</span>
                </button>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    switchLanguage(lang) {
      this.lang = lang; // Switch language dynamically
    },
